...
#     ## Feature extraction
#     # 使用 os.path.join 确保路径正确，并移除了 GPU 选项
...
#         # f' --SiftExtraction.use_gpu {use_gpu}' # 已注释掉 GPU 选项
#     )
...
#         f'--database_path "{db_path}"'
#         # f' --SiftMatching.use_gpu {use_gpu}' # 已注释掉 GPU 选项
#     )
...
if(args.resize):
    print("Copying and resizing...")
    # Resize code omitted for brevity as it was not the cause of error
    # You can keep the original resize code if needed
    pass
